...
/**
 * Service for aggregating sales data and preparing AI analytics context.
 * Performs multi-dimensional analysis on transaction history and inventory levels.
 */
public class SalesReportService {

    /**
     * DTO for holding a comprehensive snapshot of sales performance.
     */
    ...
    /**
     * Fetches a complete sales summary for today compared to yesterday.
     * Aggregates revenue, order counts, top items, and category splits.
     */
    public static SalesSummary fetchSummary() throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            // 2. TOP SELLING PRODUCTS (Top 8 by Quantity)
            ...
            // 3. CURRENT STOCK LEVELS (For AI stock recommendations)
            ...
            // 5. CATEGORY BREAKDOWN (Revenue split between Burgers, Drinks, Sides, Combos)
    ...
    /**
     * Fetches daily revenue for a trailing period of days.
     */
    ...
    /**
     * PROMPT ENGINEERING: Builds the system prompt for the Gemini AI Sales Analyst.
     * Includes rigid structure constraints and raw data for analysis.
     */
    ...
    /**
     * PROMPT ENGINEERING: Builds the system prompt for the Gemini AI Inventory Manager.
     * Provides current stock vs thresholds to trigger restock recommendations.
     */
    ...
    /**
     * Fetches a summary for an arbitrary time range.
     * Core logic used by the PDF report generators.
     */
